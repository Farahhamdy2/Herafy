  ...
  return (
    ...
    <section className='container'>
      <div className="title">
        ...
        <p>يقدم الموقع مجموعة متنوعة من الخدمات تشمل السباكة، والنجارة، والأعمال الكهربائية، لتلبية احتياجات العملاء بكل احترافية وسهولة. احجز خدمتك الآن <br/> واستمتع بجودة عالية وسرعة في التنفيذ.</p>
      </div>
